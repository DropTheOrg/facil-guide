...
faq:
  ...
  - question: "Does closing apps save battery?"
    answer: "Not really. On modern phones, apps in the background use very little power. Constantly closing and reopening apps can actually use more battery than leaving them alone."
  - question: "Does dark mode save battery?"
    answer: "Yes, but only on phones with OLED screens (most newer phones). Dark mode uses less power because the screen turns off black pixels completely."
  - question: "Should I let my battery drain to zero before charging?"
...
- [iPhone battery and performance - Apple Support](https://support.apple.com/en-us/108055)
- [Extend battery life on Android - Google Help](https://support.google.com/android/answer/7664692)
