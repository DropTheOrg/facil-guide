...
faq:
  - question: "Is Google Pay safe?"
    answer: "Yes. Google Pay does not share your real card number with the store. It creates a virtual number for each transaction, keeping your card details private."
  - question: "Do I need internet to pay in a store?"
    answer: "No. Google Pay uses NFC (a short-range wireless signal) to communicate with the card reader. It works without Wi-Fi or mobile data."
  - question: "Which phones support Google Pay?"
    answer: "Most Android phones with NFC support Google Pay. To check, go to Settings and search for NFC. If you see the option, your phone supports it."
...
2. Search for **"NFC"** using the search bar at the top
3. Make sure the **NFC** switch is turned **on**

### Step 7: Pay in a store

When you are ready to pay:

1. Unlock your phone (use your fingerprint, PIN, or face)
2. Hold the **back of your phone** near the **card reader** (the machine where you would normally tap your card)
3. Wait for a checkmark or confirmation sound
...
- [Set up Google Wallet - Google Support](https://support.google.com/wallet/answer/12059331)
- [Check if your bank supports Google Pay](https://support.google.com/wallet/answer/12060068)
