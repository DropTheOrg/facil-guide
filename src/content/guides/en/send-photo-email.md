...
faq:
  ...
  - question: "Will the photo quality be reduced?"
    answer: "Some email apps ask if you want to send the photo in its original size or a smaller size. Choose original size for the best quality, or a smaller size if the person only needs to view it on screen."
  - question: "Can I send a video the same way?"
...
- [Send email attachments on iPhone - Apple Support](https://support.apple.com/en-us/108771)
- [Send attachments in Gmail - Google Help](https://support.google.com/mail/answer/6584)
