---
title: "Comment imprimer depuis le telephone"
description: "Apprenez a imprimer des photos et documents directement depuis votre telephone."
lang: "fr"
category: "smartphone"
difficulty: "facile"
steps: 5
...
## Etape 1: Make Sure Your Printer Is On and Connected
...
## Etape 2: Open What You Want to Print

On your phone, open the document, photo, email, or web page you want to print.

## Etape 3: Find the Print Option

- **Sur iPhone :** Tap the **Share** button (square with an arrow pointing up), then scroll down and tap **Print**
- **Sur Android :** Tap the **three dots** menu (top-right corner), then tap **Print** or **Share** > **Print**

If you are in the Photos app, look for the Share button and then Print.

## Etape 4: Selectionnez Your Printer

A print preview screen will appear. Tap **Selectionnez Printer** or **Printer** and choose your printer from the list.
