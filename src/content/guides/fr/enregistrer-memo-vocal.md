---
title: "Comment enregistrer un memo vocal"
description: "Apprenez a enregistrer votre voix, une conversation ou une reunion avec le dictaphone du telephone."
lang: "fr"
category: "smartphone"
difficulty: "facile"
steps: 4
...
## Etape 1: Open the Recorder App

- **Sur iPhone :** Open the **Voice Memos** app (dark waveform icon)
- **Sur Android :** Open the **Recorder** app or **Voice Recorder** (search for it in your apps)

## Etape 2: Start Recording

Tap the large **red circle** button to start recording.

Speak clearly into the bottom of your phone (that is where the microphone is). Hold the phone about 15-20 cm from your mouth.

You will see a timer counting up, showing how long you have been recording.

## Etape 3: Stop and Save

When you are done, tap the **red square** button (or the stop button) to end the recording.

- **Sur iPhone :** The recording is saved automatically. Tap it to rename it (for example, "Doctor appointment notes")
- **Sur Android :** You may be asked to name the recording and tap **Save**

## Etape 4: Listen to Your Recording

Find your recording in the list and tap it to play it back.

You can **pause**, **rewind**, and **fast-forward** using the playback controls.
