---
title: "Comment mettre un minuteur sur le telephone"
description: "Apprenez a regler un compte a rebours pour cuisiner, faire du sport ou toute autre activite."
lang: "fr"
category: "smartphone"
difficulty: "facile"
steps: 4
...
## Etape 1: Open the Clock App

Find the **Clock** app on your phone and tap it.

- **Sur iPhone :** It looks like a white clock face on a black background
- **Sur Android :** It is usually called **Clock** with a round clock icon

## Etape 2: Go to the Timer Tab

At the bottom of the Clock app, you will see several tabs: Alarm, Clock, Timer, Stopwatch.

Tap **Timer**.

## Etape 3: Set the Time

Use the scroll wheels or number pad to set how long you want the timer to run.

For example:
- Boiling an egg: set **10 minutes**
- Baking a cake: set **30 minutes**
- A quick nap: set **20 minutes**
...
You can now close the app or use your phone for other things. The timer runs in the background.

When the time is up, your phone will ring or vibrate to let you know.

To **cancel** the timer before it finishes, open the Clock app, go to Timer, and tap **Annuler** or **Stop**.
