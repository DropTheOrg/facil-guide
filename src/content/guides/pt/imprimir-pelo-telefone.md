---
title: "[PT] How to Print a Document or Photo from Your Phone"
description: "[PT] Learn how to print a photo, document, or web page directly from your iPhone or Android phone to a wireless printer."
lang: "pt"
category: "smartphone"
difficulty: "facile"
steps: 5
...
## Step 1: Make Sure Your Printer Is On and Connected
...
- **On iPhone:** Tap the **Share** button (square with an arrow pointing up), then scroll down and tap **Print**
- **On Android:** Tap the **three dots** menu (top-right corner), then tap **Print** or **Share** > **Print**

If you are in the Photos app, look for the Share button and then Print.

## Step 4: Select Your Printer

A print preview screen will appear. Tap **Select Printer** or **Printer** and choose your printer from the list.
