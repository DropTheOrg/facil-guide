---
title: "Como imprimir pelo telefone"
description: "Aprenda a imprimir fotos e documentos diretamente a partir do seu telefone."
lang: "pt"
category: "smartphone"
difficulty: "facile"
steps: 5
...
## Passo 1: Make Sure Your Printer Is On and Connected
...
## Passo 2: Open What You Want to Print

On your phone, open the document, photo, email, or web page you want to print.

## Passo 3: Find the Print Option

- **No iPhone:** Tap the **Share** button (square with an arrow pointing up), then scroll down and tap **Print**
- **No Android:** Tap the **three dots** menu (top-right corner), then tap **Print** or **Share** > **Print**

If you are in the Photos app, look for the Share button and then Print.

## Passo 4: Selecione Your Printer

A print preview screen will appear. Tap **Selecione Printer** or **Printer** and choose your printer from the list.
