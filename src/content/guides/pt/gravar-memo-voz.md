---
title: "Como gravar um memo de voz"
description: "Aprenda a gravar a sua voz, uma conversa ou reuniao com o gravador do telefone."
lang: "pt"
category: "smartphone"
difficulty: "facile"
steps: 4
...
- **No iPhone:** Open the **Voice Memos** app (dark waveform icon)
- **No Android:** Open the **Recorder** app or **Voice Recorder** (search for it in your apps)
...
- **No iPhone:** The recording is saved automatically. Tap it to rename it (for example, "Doctor appointment notes")
- **No Android:** You may be asked to name the recording and tap **Save**
