---
title: "Come stampare dal telefono"
description: "Impari a stampare foto e documenti direttamente dal suo telefono."
lang: "it"
category: "smartphone"
difficulty: "facile"
steps: 5
...
- **Su iPhone:** Tap the **Share** button (square with an arrow pointing up), then scroll down and tap **Print**
- **Su Android:** Tap the **three dots** menu (top-right corner), then tap **Print** or **Share** > **Print**

If you are in the Photos app, look for the Share button and then Print.

## Passo 4: Selezioni Your Printer

A print preview screen will appear. Tap **Selezioni Printer** or **Printer** and choose your printer from the list.
